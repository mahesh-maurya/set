...
{	
 ...
 public function getActionswithfunction($controller, $module=null)
    {
        ...
        if ($module!=null){
            ...
            $path='backend'.DIRECTORY_SEPARATOR.'controllers';
        }        
        ...
        {           
         ...
         if(method_exists($controller, 'custompermission')){
         		$custom  = $controller::custompermission();
