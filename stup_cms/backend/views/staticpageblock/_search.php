<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'static_page_id',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'page_menu',array('class'=>'span5','maxlength'=>100)); ?>
	...
	<?php echo $form->textFieldRow($model,'attachment',array('class'=>'span5','maxlength'=>500)); ?>
