<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListRow($model,'page_name',$allpages,array('empty'=>'Select Page'));?>
	...
	{
		$getfullpath=ApplicationConfig::app()->params["url_path"]["page_banners"].$model->image;
	?>
