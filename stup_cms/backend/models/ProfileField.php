...
class ProfileField extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('varname', 'match', 'pattern' => '/^[A-Za-z_0-9]+$/u','message' => "Variable name may consist of A-z, 0-9, underscores, begin with a letter."),
			array('varname', 'unique', 'message' => "This field already exists."),
